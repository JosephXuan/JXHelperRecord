...
//  TestFontAutoSize
//
//  Created by Joseph_Xuan on 17/7/6.
...
@interface FmdbViewCtrl ()

@end

@implementation FmdbViewCtrl
...
- (void)viewDidLoad {
    ...
    person.photoData = UIImagePNGRepresentation([UIImage imageNamed:@"1.jpg"]);
    person.luckyNum = 7;
    person.sex = 0;
    person.age = 26;
 ...
 person.testArr=@[@"textzz",@"textxx",@"textcc",@"textvv",@"textbb",@"textnn",@"textmm"];
    // 用来测试操作一组数据
