...
@interface PickPublishView ()<UICollectionViewDelegate,UICollectionViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate,TZImagePickerControllerDelegate>{
    /** 照片数组 */
...
@implementation PickPublishView
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
     ...
     UIViewController * pvc =[self getCurrentCtrl];
    if (indexPath.item == _selectedPhotos.count) {
        ...
        if ([[asset valueForKey:@"filename"] tz_containsString:@"GIF"] ) {
            ...
            [pvc presentViewController:imagePickerVc animated:YES completion:nil];
        }
    }
}
...
-(UIViewController *)getCurrentCtrl{
