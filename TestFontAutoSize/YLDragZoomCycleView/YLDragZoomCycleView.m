...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.delegate && [self.delegate respondsToSelector:@selector(didSelectedItem:withView:)]) {
        YLZoomCycleViewCell *cell =(YLZoomCycleViewCell*)[collectionView cellForItemAtIndexPath:indexPath];
        [self.delegate didSelectedItem:indexPath.item % self.dataSource.count withView:cell.imageView];
        
    }

}
#pragma mark-- colltionView的scroll
